    ...
    ArrayAdapter<Recipe>(context, R.layout.recipe_row, arr)
{
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val r_imageView = rootView.findViewById<ImageView>(R.id.r_image)

        r_name.setText(dt.name)
        r_caloriesPerServing.setText("${dt.caloriesPerServing} calories")

        Glide.with(rootView).load(dt.image).into(r_imageView)
